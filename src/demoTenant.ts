...
/**
 * Provider-console org directory (dashboard, tenant org table, etc.) — same institution names as tenant shell.
 */
export const DEMO_TENANT_PROVIDER_ORG_LABEL: Record<DemoTenantId, string> = {
  northstar: DEMO_TENANT_LABEL.northstar,
  evergreen: DEMO_TENANT_LABEL.evergreen,
  vertexa: DEMO_TENANT_LABEL.vertexa,
}
