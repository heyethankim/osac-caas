...
export function buildProviderAdminRecentActivities(): TenantAdminRecentActivity[] {
  return [
    ...
    },
    {
      ...
      labelColor: 'blue',
      timeLabel: '6 hr ago',
      title: 'BlueSolace Financial Group onboarding checklist',
      detail:
    ...
    },
    {
      ...
      detail:
        'North Summit Bank and BlueSolace Financial Group memory and storage entitlements were updated per renewed platform agreements.',
    },
  ]
}
